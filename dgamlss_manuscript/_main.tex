...
\urlstyle{same}
\hypersetup{
  pdftitle={dGAMLSS: An exact, distributed algorithm to fit Generalized Additive Models for Location, Scale, and Shape for privacy-preserving biomedical inference},
  hidelinks,
...
\addcontentsline{toc}{section}{Disclosures and Conflicts of Interest}
